...
* Студент: [Александр Толстик](https://up.htmlacademy.ru/htmlcss/37/user/2333495).
* Наставник: `Максим Жевцов`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/2333495-sedona-37) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
